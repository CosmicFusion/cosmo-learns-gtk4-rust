...
fn build_ui(app: &Application) {
    ...
    // Connects the clicking of  "_click_me_button" to the external function "print_hello" and idk why but everyone tells me to be "move |_| " before the external function
    _click_me_button.connect_clicked(move |_| print_hello());
